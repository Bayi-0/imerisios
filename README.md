...
- **Habit Manage Box**: Allows users to create new habits; delete, rename, stop/resume tracking of created ones.
...
- **Habit More Box**: Shows detailed and analyzed data for selected habit.
